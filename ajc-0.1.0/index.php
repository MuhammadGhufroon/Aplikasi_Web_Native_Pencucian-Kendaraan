...
<head>
	...
	body {
	  padding-top: 40px;
	  padding-bottom: 40px;
	  background-image: url("img/pexels-jan-kopřiva-3354648.jpg");
  ...
  <body>
	...
	?>
      <form class="form-signin" method="post" action="" role="form">
		...
		?>
        <div class="container">
  		<h2 class="form-signin-heading text-center text-uppercase text-primary"><b>Login Page</b></h2>
        <input type="text" name="username" class="form-control" placeholder="Username" required autofocus>
        <input type="password" name="password" class="form-control" placeholder="Password" required>
        <button class="btn btn-lg btn-dark btn-block" type="submit" name="login"><b>Login</b></button>
		</div>
      </form>
	<?php
	}
